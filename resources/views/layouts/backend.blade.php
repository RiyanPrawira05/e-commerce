...
<head>
	...
	<title>RD Shop - Content Management</title>
	<!-- Favicon -->
...
<body>
	...
	<div class="container-fluid">
		...
		<!-- Brand -->
		<a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./index.html">@yield('brand')</a>
		...
		<ul class="navbar-nav align-items-center d-none d-md-flex">
			...
			<!-- Header -->
			<div class="header bg-gradient-primary {{ trim($__env->yieldContent('header')) ? 'pb-8 pt-5 pt-md-8' : 'pb-1 pt-5 pt-md-6' }}">
				<div class="container-fluid">
