                            ...
                            <div class="form-group">
                                <div class="input-group input-group-alternative">
                                    <div class="input-group-prepend">
                                        ...
                                        <input class="form-control datepicker" placeholder="Select date" name="open_discount" type="text" data-date-format="yyyy-mm-dd" value="{{ \Carbon\Carbon::parse($discounts->open_discount)->format('Y-m-d') }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="input-group input-group-alternative">
                                    <div class="input-group-prepend">
                                        ...
                                        <input class="form-control datepicker" placeholder="Select date" name="expired_discount" type="text" data-date-format="yyyy-mm-dd" value="{{ \Carbon\Carbon::parse($discounts->expired_discount)->format('Y-m-d') }}">
                                </div>
                            </div>
                        </div>
