...
@section('brand') Add Size @endsection
            ...
            <div class="card-header border-1">
                <div class="row align-items-center">
                    ...
                    <div class="col-4 text-right">
                        <h4 class="heading-small text-muted mb-0">Create Size</h4>
                    </div>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="size" class="form-control form-control-alternative" placeholder="S/M/L/XL" required autofocus>
                                </div>
                            </div>
                        </div>
                    </div>
