         ...
         <div class="card-body">
            <div class="row">
               ...
               <p class="mt-3 mb-0 text-muted text-sm">
                  <span class="text-success mr-2"><i class="fa fa-arrow-up"></i>&nbsp;{{ $products->count() }}%</span>
                  <span class="text-nowrap">Data product</span>
               </p>
            </div>
         </div>
      </div>
    ...
    <div class="col-xl-3 col-lg-6">
      <div class="card card-stats mb-4 mb-xl-0">
        <div class="card-body">
          ...
          <p class="mt-3 mb-0 text-muted text-sm">
            <span class="text-success mr-2"><i class="fas fa-arrow-up"></i>&nbsp;{{ $users->count() }}% </span>
            <span class="text-nowrap">Data Users</span>
          </p>
        </div>
      </div>
    </div>
